...
window.unifiedData = {
    ...
    meta: {
        ...
        dataWeek: {
            number: 34,
            year: 2025,
            range: 'August 22-28, 2025'
        },
        analysis: {
            episodesAnalyzed: 1498,
            podcastsTracked: 47,
            hoursAnalyzed: 1044,
            lastAnalysis: '36 mins ago'
        }
    },
    ...
    narrativePulse: {
        ...
        topics: {
            'AI Agents': {
                ...
                description: 'Autonomous AI systems gaining tier-1 VC attention',
                chartData: {
                    '7d': {
                        momentum: {
            ...
            'AI Infrastructure': {
                ...
                mentions: 208,
                episodes: 41,
                consensusLevel: 'Peak (>90% agreement)',
                description: '"Picks and shovels" thesis at peak consensus',
                chartData: {
                    '7d': {
                        momentum: {
            ...
            'Capital Efficiency': {
                ...
                mentions: 89,
                episodes: 31,
                consensusLevel: 'Building (60-80% agreement)',
                description: 'Fundamentals matter narrative rebounds',
                chartData: {
                    '7d': {
                        momentum: {
            ...
            'DePIN': {
                ...
                mentions: 201,
                episodes: 18,
                consensusLevel: 'Mixed (40-60% agreement)',
                description: 'Physical infrastructure narrative gains momentum',
                chartData: {
                    '7d': {
                        momentum: {
            ...
            'Crypto/Web3': {
                ...
                mentions: 112,
                episodes: 28,
                consensusLevel: 'Moderate (50% agreement)',
                description: 'Regulatory clarity sparks recovery',
                chartData: {
                    '7d': {
                        momentum: {
            ...
            'B2B SaaS': {
                ...
                mentions: 43,
                episodes: 12,
                consensusLevel: 'Weak (<40% agreement)',
                description: 'Legacy SaaS struggles as AI-native dominates',
                chartData: {
                    '7d': {
                        momentum: {
            ...
            'Developer Tools': {
                ...
                episodes: 19,
                consensusLevel: 'Strong (>80% agreement)',
                description: 'AI coding assistants driving renaissance',
                chartData: {
                    '7d': {
                        momentum: {
    ...
    weeklyBrief: {
        executive: {
            summary: [
                {
                    type: 'consensus',
                    text: 'AI infrastructure reaches peak consensus',
                    details: '[52 mentions across 48 sources, led by All-In, 20VC] with "picks and shovels" thesis driving massive funding rounds.'
                },
                {
                    type: 'growth',
                    text: 'DePIN explodes +78% w/w',
                    details: '[32 mentions] as physical infrastructure narrative gains tier-1 VC attention following major funding rumors.'
                },
                {
                    type: 'contrarian',
                    text: 'Notable reversal:',
                    details: 'Crypto/Web3 rebounds +18% after months of decline, driven by regulatory clarity and Base ecosystem momentum.'
                },
                {
                    type: 'warning',
                    text: 'Warning signal:',
                    details: 'B2B SaaS drops -20% as AI-native solutions render legacy playbooks obsolete.'
                }
            ]
        },
        keyMetrics: [
        ...
        topicMomentum: [
            {
                ...
                momentum: 78,
                mentions: 32,
                context: 'major funding rumors driving narrative',
                direction: 'positive'
            },
            {
                name: 'AI Agents',
                ...
                momentum: 59,
                mentions: 35,
                context: 'tier-1 VCs aligning on thesis',
                direction: 'positive'
            },
            {
                ...
                momentum: 37,
                mentions: 52,
                context: '"picks and shovels" thesis at peak consensus',
                direction: 'positive'
            },
            {
                ...
                momentum: 29,
                mentions: 18,
                context: 'AI coding assistants driving renaissance',
                direction: 'positive'
            },
            {
                name: 'Crypto/Web3',
                ...
                momentum: 18,
                mentions: 26,
                context: 'regulatory clarity sparks recovery',
                direction: 'positive'
            },
            {
                ...
                momentum: 15,
                mentions: 15,
                context: 'fundamentals matter narrative rebounds',
                direction: 'positive'
            },
            {
                name: 'B2B SaaS',
                ...
                momentum: 20,
                mentions: 8,
                context: 'legacy SaaS struggles as AI-native dominates',
                direction: 'negative'
            }
        ],
        consensusForming: [
            {
                title: 'AI infrastructure at peak consensus',
                sources: '[48 positive sources out of 52 mentions: All-In dedicates full segment]',
                insight: '"Picks and shovels" wins - everyone wants foundation layer exposure'
            },
            {
                title: 'DePIN summer emerging',
                sources: '[28 positive sources out of 32: Helium success story drives narrative]',
                insight: 'Physical meets digital - major funds announce DePIN strategies'
            },
            {
                title: 'Developer productivity renaissance',
                sources: '[16 positive out of 18 mentions: Cursor rumors spark interest]',
                insight: 'AI coding assistants showing measurable productivity gains'
            }
        ],
        contrarian: [
            {
                title: 'B2B SaaS accelerating decline',
                description: '-20% drop while AI categories surge',
                context: 'Legacy playbooks becoming obsolete'
            },
            {
                title: 'Capital Efficiency momentum slowing',
                description: 'Only +15% despite LP pressure',
                context: 'AI growth overriding discipline narrative'
            }
        ],
        blindspots: [
            {
                title: 'DePIN sustainability questions',
                description: '+78% growth without unit economics',
                context: 'Only 3 negative voices out of 32'
            },
            {
                title: 'AI agent revenue models unclear',
                description: '+59% momentum but monetization TBD',
                context: 'Enthusiasm outpacing business models'
            }
        ],
        actionItems: {
            thisWeek: [
                'Focus area: AI infrastructure opportunities',
                'Connect with Databricks/Snowflake alumni',
                'Portfolio efficiency review suggested'
            ],
            monitor: [
                'Monitor: DePIN sustainability questions',
                'Developer tools M&A activity',
                'Climate tech contrarian plays'
            ]
        }
    },
